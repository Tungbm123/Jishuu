...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
    ...
    <div class="sidebar-brand">
        ...
        <a href="<?php echo _HOST_URL ?>" class="brand-link">
            <!--begin::Brand Image-->
            <img
                src="https://png.pngtree.com/png-vector/20250210/ourmid/pngtree-logo-template-for-esports-vector-illustration-of-a-lion-combination-red-png-image_15440797.png"
                alt="AdminLTE Logo"
                class="brand-image opacity-75 shadow" />
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">TUNGBM</span>
            <!--end::Brand Text-->
        </a>
        <!--end::Brand Link-->
    </div>
